...
},{"./emptyFunction":19}],26:[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"fbjs/lib/invariant":14,"fbjs/lib/warning":15,"./lib/ReactPropTypesSecret":26}],13:[function(require,module,exports) {
...
},{"object-assign":17,"fbjs/lib/invariant":14,"fbjs/lib/emptyObject":23,"fbjs/lib/warning":15,"fbjs/lib/emptyFunction":19,"prop-types/checkPropTypes":18}],6:[function(require,module,exports) {
'use strict';
...
},{"./cjs/react.development.js":13}],16:[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"./isTextNode":27}],30:[function(require,module,exports) {
'use strict';
...
},{"fbjs/lib/invariant":14,"react":6,"fbjs/lib/warning":15,"fbjs/lib/ExecutionEnvironment":16,"object-assign":17,"fbjs/lib/emptyFunction":19,"prop-types/checkPropTypes":18,"fbjs/lib/getActiveElement":20,"fbjs/lib/shallowEqual":21,"fbjs/lib/containsNode":22,"fbjs/lib/emptyObject":23,"fbjs/lib/hyphenateStyleName":25,"fbjs/lib/camelizeStyleName":24}],7:[function(require,module,exports) {
'use strict';
...
},{"./cjs/react-dom.development.js":12}],34:[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
	value: true
});
var __DO_NOT_USE__store = {
	__proto__: {
		__GET_STORE__: function __GET_STORE__() {
			return __DO_NOT_USE__store;
		}
	}
};
...
exports.__DO_NOT_USE__store = __DO_NOT_USE__store;
...
var SimpleRedux = function (_Component) {
	_inherits(SimpleRedux, _Component);

	function SimpleRedux(props) {
		_classCallCheck(this, SimpleRedux);

		var _this = _possibleConstructorReturn(this, (SimpleRedux.__proto__ || Object.getPrototypeOf(SimpleRedux)).call(this, props));

		var store = _Actions.__DO_NOT_USE__store.__GET_STORE__();
		_this.actions = store;
		return _this;
	}
...
},{"react":6,"./Actions":34}],32:[function(require,module,exports) {
'use strict';

Object.defineProperty(exports, "__esModule", {
	value: true
});
exports.RegisterAction = exports.SimpleRedux = undefined;

var _SimpleRedux = require('./SimpleRedux');

var _SimpleRedux2 = _interopRequireDefault(_SimpleRedux);

var _Actions = require('./Actions');

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.SimpleRedux = _SimpleRedux2.default;
exports.RegisterAction = _Actions.RegisterAction;
},{"./SimpleRedux":33,"./Actions":34}],4:[function(require,module,exports) {
'use strict';
...
var value = 0;
(0, _src.RegisterAction)('getValue', function () {
	return value;
});

var Test3 = function (_SimpleRedux) {
	_inherits(Test3, _SimpleRedux);
	...
	_createClass(Test3, [{
		...
		value: function render() {
			var value = this.actions.getValue();
...
var Test2 = function (_SimpleRedux2) {
	_inherits(Test2, _SimpleRedux2);
	...
	_createClass(Test2, [{
		...
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(Test3, null)
			);
		}
	}]);
...
_reactDom2.default.render(_react2.default.createElement(Test2, null), document.getElementById('root'));
},{"react":6,"react-dom":7,"../src":32}],43:[function(require,module,exports) {
...
//# sourceMappingURL=/test.8925118d.map